...
class DistrictSecretaryData extends StatefulWidget {
  @override
  _DistrictSecretaryDataState createState() => _DistrictSecretaryDataState();
}

class _DistrictSecretaryDataState extends State<DistrictSecretaryData> {
