...
class StateSecretaryData extends StatefulWidget {
  @override
  _StateSecretaryDataState createState() => _StateSecretaryDataState();
}

class _StateSecretaryDataState extends State<StateSecretaryData> {
  List<StateSecretaryModel> tableData = [];
  List<StateSecretaryModel> allDistrictSecretaries = [];
  ...
  Future<void> _getDistrictSecretaries() async {
    List<StateSecretaryModel> fetchedSecretaries =
  ...
  void addSecretary(StateSecretaryModel secretary) {
    setState(() {
  ...
  Future<void> exportToExcel(
      BuildContext context, List<StateSecretaryModel> secretaries) async {
    try {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: Text("District Secretaries"),
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: PaginatedDataTable(
                        ...
                        columns: const [
                          ...
                          DataColumn(label: Text('STATE ID')),
  ...
  void showDistrictSecretaryDetailsDialog(StateSecretaryModel secretary) {
    // showDialog(
    //   context: context,
  ...
  void editSecretaryDialog(BuildContext context,StateSecretaryModel StateSecretaryModel) {
    // showDialog(
    //   context: context,
    //   builder: (BuildContext context) {
    //     return EditDistrictSecretaryDialog( updateDistrictSecretary: updateSecretary, StateSecretaryModel: StateSecretaryModel,);
    //   },
    // );
  }

  void updateSecretary(StateSecretaryModel secretary) {
    setState(() {
  ...
  void addDitsrictSecretary(StateSecretaryModel secretary){
    setState(() {
      tableData.add(secretary);
    });
  }

  void deleteSecretary(StateSecretaryModel secretary) async {
  ...
  void approveSecretary(StateSecretaryModel secretary) {
    final ref =
    FirebaseDatabase.instance.ref('districtSecretaries/${secretary.id}');
...
class MyData extends DataTableSource {
  final List<StateSecretaryModel> data;
  final Function(StateSecretaryModel) showDistrictSecretaryDetailsDialog;
  final Function(BuildContext context,StateSecretaryModel) showEditDialog;
  final Function(StateSecretaryModel) deleteSecretary;
  ...
  DataRow? getRow(int index) {
    ...
    final StateSecretaryModel secretary = data[index];
