...
class Skaters extends StatefulWidget {
  String? districtName;
  Skaters({required this.districtName});
...
class _SkatersState extends State<Skaters> {
  ...
  Future<void> getUsers() async {
    ...
    setState(() {
      print(2);
      tableData = users.where((element) => element.district.contains(widget.districtName!)).toList();
      allSkaters = users.where((element) => element.district.contains(widget.districtName!)).toList();
