...
import 'package:sport_ims/districtApp/DistrictClubsParticipantsPage.dart';
import 'package:sport_ims/districtApp/DistrictClubsSkatersPage.dart';
import 'package:sport_ims/districtApp/DistrictSecretaryDetails.dart';
...
class DistrictApp extends StatefulWidget {
  ...
  DistrictApp({required this.credentials});
...
class _DistrictAppState extends State<DistrictApp> {
  ...
  DistrictSecretaryModel? districtSecretaryModel;
  ...
  Future<void> _getDistrictSecretaries() async {
    List<DistrictSecretaryModel> fetchedSecretaries = await getDistrictSecretaries();
    districtSecretaryModel = fetchedSecretaries.firstWhere((element) => element.id==widget.credentials.username);
    setState(() {
      pages= [
        LoadingScreen(),                                  //0
        Skaters(clubName: districtSecretaryModel!.districtName)  ,   //1
        DistrictSecretaryDetailsPage( districtSecretary: districtSecretaryModel!, updateDistrictSecretaryApproval: (DistrictSecretaryModel ) {  },),//2
        EventsData(), //3,//Used from ClubAPP
        DistrictClubsParticipantsPage(districtName: districtSecretaryModel!.districtName,),
        DistrictClubsSkatersPage(districtName: districtSecretaryModel!.districtName)
      ];
    });
  }
