...
class DistrictApprovel extends StatefulWidget {
  const DistrictApprovel({super.key});

  @override
  State<DistrictApprovel> createState() => _DistrictApprovelState();
}

class _DistrictApprovelState extends State<DistrictApprovel> {
  @override
...
class _RightSideState extends State<RightSide> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text("District Secretary Pending Approvel"),
                            ...
                            child: Container(
                              ...
                              child: DataTable(
                                ...
                                columns: [
                                  ...
                                  DataColumn(label: Text(' District ID'), numeric: false),
                                  DataColumn(label: Text('District Name'), numeric: false),
