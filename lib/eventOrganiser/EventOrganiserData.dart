...
import 'AddEventOrganiserDialog.dart';
import 'EditEventOrganiserDialog.dart';
import 'EventOrganiserDetailsPage.dart';

class EventOrganiserData extends StatefulWidget {
  const EventOrganiserData({super.key});

  @override
  State<EventOrganiserData> createState() => _EventOrganiserDataState();
}

class _EventOrganiserDataState extends State<EventOrganiserData> {
  @override
...
class _RightSideState extends State<RightSide> {
  ...
  Future<void> getEventOrganiser() async {
    ...
    try {
      ...
      eventOrganisers =eventOrganisers.where((element) => element.deleteStatus==false).toList();

      setState(() {
        print(2);
        tableData = eventOrganisers;
        allSkaters = eventOrganisers;
        print(3);
      });
    } catch (e) {
  ...
  Future<void> showEditDialog(EventOrganiser eventOrganiser) async {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return EditEventOrganiserDialog(eventOrganiser: eventOrganiser,  updateEventOrganiser: updateEventOrganiser);
      },
    );
  }
  ...
  void addNewEventOrganiserDialog(BuildContext context) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AddNewEventOrganiserDialog(updateEventOrganiser: addEventOrganiser,);
      },
    );
  }
  ...
  void deleteEventOrganiser(EventOrganiser eventOrganiser) async {
    ...
    // Perform deletion
    try {
      final ref = FirebaseDatabase.instance.ref('eventOrganisers/${eventOrganiser.id}/deleteStatus/');
      ref.set(true);
...
class MyData extends DataTableSource {
  ...
  DataRow? getRow(int index) {
    ...
    return DataRow.byIndex(index: index, cells: [
      ...
      DataCell(buildEllipseTextContainer( eventOrganiser.eventName,180)),
      DataCell(IconButton(
