...
class _EditClubDialogState extends State<EditClubDialog> {
  ...
  Future<void> saveClubData() async {
    ...
    Club updatedClub = Club(
      id: widget.club.id,
      clubName: widget.club.clubName, // Do not allow modification of club name
      address: addressController.text,
      state: widget.club.state, // Do not allow modification of state
      district: widget.club.district, // Do not allow modification of district
      contactNumber: contactController.text,
      email: emailController.text,
      coachName: coachNameController.text,
      masterName: widget.club.masterName, // Do not allow modification of master name
