...
class Skaters extends StatefulWidget {
  String? clubName;
  Skaters({required this.clubName});
...
class _SkatersState extends State<Skaters> {
  ...
  Future<void> getUsers() async {
    ...
    setState(() {
      print(2);
      tableData = users.where((element) => element.club.contains(widget.clubName!)).toList();
      allSkaters = users.where((element) => element.club.contains(widget.clubName!)).toList();
