...
class EventOrganiser extends StatefulWidget {
  const EventOrganiser({super.key});

  @override
  State<EventOrganiser> createState() => _EventOrganiserState();
}
...
class _RightSideState extends State<RightSide> {
  ...
  List<EventOrganiserModel> tableData = [
    EventOrganiserModel("s001", "Arunraj","Virudhunagar District Roller\nSkating Championshio"),
    EventOrganiserModel("s001", "Arunraj","Virudhunagar District Roller\nSkating Championshio"),
    EventOrganiserModel("s001", "Arunraj","Virudhunagar District Roller\nSkating Championshio"),
    EventOrganiserModel("s001", "Arunraj","Virudhunagar District Roller\nSkating Championshio"),
    EventOrganiserModel("s001", "Arunraj","Virudhunagar District Roller\nSkating Championshio"),
            ...
            child: Column(
              ...
              children: [
                ...
                if(!addNewState)Expanded(
                  child: Container(
                    width: MediaQuery.of(context).size.width*0.8, // Set width to match the screen width
                          ...
                          child: DataTable(
                            ...
                            rows: List.generate(tableData.length, (index) {
                              return DataRow(cells: [
                                ...
                                DataCell(Text(tableData[index].UserName)),
...
class EventOrganiserModel {
  String serialnumber,UserName,Events;

  EventOrganiserModel(this.serialnumber, this.UserName,this.Events);
