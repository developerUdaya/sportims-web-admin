...
class ClubApproval extends StatefulWidget {
  @override
  _ClubApprovalState createState() => _ClubApprovalState();
}

class _ClubApprovalState extends State<ClubApproval> {
  List<Club> tableData = [];
  List<Club> allClubs = [];
  ...
  Future<void> _getClubs() async {
    ...
    fetchedClubs = fetchedClubs.where((element) => element.approval!="Approved").toList();
    setState(() {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        home: Scaffold(
        appBar: AppBar(
        title: Text("Clubs Pending Approval"),
